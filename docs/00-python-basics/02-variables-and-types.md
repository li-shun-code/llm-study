---
title: 变量与基本类型
source_url: https://liaoxuefeng.com/books/python/basic/data-types/index.html
author: 廖雪峰
license: © 廖雪峰（转载署名）
...
浮点数也就是小数，之所以称为浮点数，是因为按照科学记数法表示时，一个浮点数的小数点位置是可变的，比如 1.23×10⁹ 和 12.3×10⁸ 是完全相等的。浮点数可以用数学写法，如`1.23`，`3.14`，`-9.01`，等等。但是对于很大或很小的浮点数，就必须用科学计数法表示，把10用e替代，1.23×10⁹ 就是`1.23e9`，或者 12.3×10⁸ 就是`12.3e8`，0.000012可以写成`1.2e-5`，等等。
...
> **来源**：本文转载自 [数据类型和变量 - Python教程](https://liaoxuefeng.com/books/python/basic/data-types/index.html)，作者 廖雪峰，许可 © 廖雪峰（转载署名）。抓取于 2026-09-13。
