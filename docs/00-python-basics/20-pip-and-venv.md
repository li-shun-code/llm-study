---
title: pip 与虚拟环境
source_url: https://docs.python.org/zh-cn/3/tutorial/venv.html
...
这个问题的解决方案是创建一个 virtual environment（虚拟环境），一个目录树，其中安装有特定 Python 版本，以及许多其他包。
...
你可以使用一个名为 **pip** 的程序来安装、升级和移除软件包。默认情况下 `pip` 将从 [Python Package Index](https://pypi.org)（PyPI）安装软件包。你可以在你的 web 浏览器中查看 Python Package Index。
