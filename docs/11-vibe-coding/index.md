...
- Cursor 入门与 Rules
- Cursor 深入：Tab 补全、Agent 模式与调试/评审
...
- 我的 LLM 代码生成工作流（Harper Reed 名篇全文翻译）
- 初级开发者的复仇（Steve Yegge 名篇全文翻译）
- Ralph Wiggum 作为"软件工程师"（Geoffrey Huntley 名篇全文翻译）
- Vibe Coding 中文实战精选：vibe-coding-cn 的核心命题、经验心法与拼好码
- AI 编程开发指南精选：鱼皮 ai-guide 的核心心法与 Claude Code 配置哲学

> 本模块文章全部抓取/翻译自网络公开资料，每篇文末署名原文出处；篇与篇之间以"承接/预告"衔接，建议按顺序阅读。
