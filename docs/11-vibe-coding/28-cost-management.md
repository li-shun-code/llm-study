...
前面三篇讲的是"AI 代码的隐性风险"——安全陷阱、供应链投毒与 IP 合规，本篇讲另一种隐性成本——**字面意义的账单**。第 6 篇说过"上下文是稀缺资源"；稀缺的另一面是"贵"。当无人值守的智能体（第 24 篇）成批消耗 token 时，成本管理就从"个人习惯"升级为"工程问题"。本篇主体翻译 Claude Code 官方文档《Manage costs effectively》：如何看账、如何按组织设限、以及十几种降耗策略。
