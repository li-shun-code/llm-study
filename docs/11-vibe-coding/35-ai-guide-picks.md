...
编者按语：本模块对同一主题的覆盖更偏官方文档与英文一手名篇，ai-guide 的价值在于中文语境的实操细节与本土工具生态（国内模型对接、封号应对、成本省钱技巧等）。与第 31 篇 Harper Reed 的英文工作流对读，你会发现"先规划后执行、小步迭代、上下文为王"在两个社区是完全一致的共识。
