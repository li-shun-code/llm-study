...
export default {
      ...
      "items": [
        ...
        },
        {
          ...
          "items": [
            {
              "text": "变量与基本类型",
              "link": "/00-python-basics/04-variables-and-types"
            },
            {
              "text": "数字与字符串（f-string 与 UTF-8 编码）",
              "link": "/00-python-basics/05-numbers-and-strings"
            },
            {
              "text": "可变/不可变与深浅拷贝",
  ...
  "/01-python-advanced/": [
    {
      "text": "模块 1 · Python 进阶与工程化",
      "link": "/01-python-advanced/",
      "collapsed": false,
      "items": [
        {
          "text": "语言机制进阶",
          ...
          "items": [
            ...
            },
            {
              ...
              "link": "/01-python-advanced/02-iterators-and-generators"
            },
            {
            ...
            },
            {
              ...
              "link": "/01-python-advanced/05-type-hints"
            },
            {
      ...
      "items": [
        {
          ...
          "items": [
            {
              "text": "复杂度分析",
              "link": "/02-dsa/01-complexity"
            },
            {
              "text": "递归入门",
              "link": "/02-dsa/02-recursion"
            }
          ]
        },
        {
          ...
          "items": [
            {
              "text": "数组",
              "link": "/02-dsa/03-array"
            },
            {
              "text": "链表",
              "link": "/02-dsa/04-linked-list"
            },
            {
              "text": "栈",
              "link": "/02-dsa/05-stack"
            },
            {
              "text": "队列",
              "link": "/02-dsa/06-queue"
            },
            {
              "text": "LRU 缓存（哈希表 + 双向链表）",
              "link": "/02-dsa/07-lru-cache"
            }
          ]
        },
        {
          ...
          "items": [
            {
              ...
              "link": "/03-cs-fundamentals/01-linux-common-commands"
            },
            {
              "text": "Shell 脚本入门",
              "link": "/03-cs-fundamentals/02-shell-scripting"
            },
            {
              "text": "文件权限",
              "link": "/03-cs-fundamentals/03-file-permissions"
            },
            {
              "text": "SSH：远程开发基础",
              "link": "/03-cs-fundamentals/04-ssh"
            }
          ]
        },
        {
          ...
          "items": [
            {
              ...
              "link": "/03-cs-fundamentals/05-git-basics"
            },
            {
              "text": "Git 分支、合并与远程协作",
              "link": "/03-cs-fundamentals/06-git-branching"
            },
            {
          ...
          "items": [
            {
              ...
              "link": "/03-cs-fundamentals/09-os-overview"
            },
            {
              "text": "进程：运行中的程序",
              "link": "/03-cs-fundamentals/10-processes"
            },
            {
              "text": "线程：并发导论",
              "link": "/03-cs-fundamentals/11-threads"
            },
            {
              "text": "并发与锁",
        ...
        },
        {
          ...
          "items": [
            ...
            },
            {
              ...
              "link": "/05-prompt-engineering/04-react-pattern"
            },
            {
  ...
  "/08-rag/": [
    {
      ...
      "items": [
          ...
          "items": [
            {
              ...
              "link": "/08-rag/03-document-parsing-ingestion"
            },
            {
        ...
        {
          "text": "检索层：相似度、过滤、混合与重排",
          "collapsed": false,
          "items": [
            {
              "text": "向量检索与相似度：欧氏距离、点积与余弦相似度",
              "link": "/08-rag/08-vector-search-similarity"
            },
            {
              "text": "元数据过滤与多维过滤检索",
      ...
      "items": [
        {
          ...
          "items": [
            ...
            },
            {
              ...
              "link": "/09-agents/03-planning-decomposition"
            }
          ]
        },
        {
          ...
          "items": [
            {
              ...
              "link": "/09-agents/04-tool-use-in-practice"
            },
            {
              "text": "Function Calling vs MCP：两代工具接入方式如何取舍",
              "link": "/09-agents/05-function-calling-vs-mcp"
            },
            {
  ...
  "/11-ai-coding-tools/": [
    {
      "text": "模块 11 · AI 编程工具与环境",
      "link": "/11-ai-coding-tools/",
      "collapsed": false,
      "items": [
        {
          "text": "概念、工具全景与评测",
          ...
          "items": [
            {
              ...
              "link": "/11-ai-coding-tools/01-what-is-vibe-coding"
            },
            {
              "text": "AI 编程工具全景对比（2026-09 版）",
              "link": "/11-ai-coding-tools/02-ai-coding-tools-landscape"
            },
            {
              "text": "AI 编码工具与模型评测基准：SWE-bench 与 Terminal-Bench",
              "link": "/11-ai-coding-tools/03-benchmarks-swe-bench"
            },
            {
              "text": "心智模型：LLM 如何\"看\"你的代码",
              "link": "/11-ai-coding-tools/04-llm-mental-model"
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "items": [
            ...
            },
            {
              ...
              "link": "/11-ai-coding-tools/07-claude-code-permissions"
            }
          ]
        },
        {
          ...
          "items": [
            {
              ...
              "link": "/11-ai-coding-tools/08-cursor-rules"
            },
            {
              "text": "Cursor 深入：Tab 补全、Agent 模式与调试/评审工作流",
              "link": "/11-ai-coding-tools/09-cursor-modes"
            },
            {
  ...
  "/12-ai-coding-context/": [
    {
      "text": "模块 12 · 规范、上下文与技能",
      "link": "/12-ai-coding-context/",
      "collapsed": false,
      "items": [
        {
          "text": "项目规范与技能包",
          ...
          "items": [
            {
              ...
              "link": "/12-ai-coding-context/01-agents-md-claude-md"
            },
            {
  ...
  "/13-ai-coding-engineering/": [
    {
      "text": "模块 13 · AI 工程实践与质量安全",
      "link": "/13-ai-coding-engineering/",
      "collapsed": false,
      "items": [
        {
          "text": "日常开发流",
          ...
          "items": [
            {
              ...
              "link": "/13-ai-coding-engineering/01-first-ai-pairing-cli-tool"
            },
            {
              "text": "Git in AI 工作流：commit 即存档、worktree 隔离与审查流",
              "link": "/13-ai-coding-engineering/02-git-in-ai-workflow"
            },
            {
              "text": "调试 with AI：让 AI 定位 Bug 的工作流",
              "link": "/13-ai-coding-engineering/03-debugging-with-ai"
            },
            {
              "text": "重构 with AI：从日常重构到百万行迁移的上下文策略",
              "link": "/13-ai-coding-engineering/04-refactoring-with-ai"
            },
            {
              "text": "TDD with AI：Kent Beck 的增强编程实践",
              "link": "/13-ai-coding-engineering/05-tdd-with-ai"
            },
            {
              "text": "AI 结对与代码审查",
              "link": "/13-ai-coding-engineering/06-ai-pairing-code-review"
            }
          ]
        },
        {
          ...
          "items": [
            ...
            },
            {
              ...
              "link": "/13-ai-coding-engineering/08-ai-supply-chain-security"
            },
            {
              "text": "AI 生成代码的 IP 与合规：版权承诺、责任边界与可版权性",
              "link": "/13-ai-coding-engineering/09-ai-code-ip-compliance"
            }
          ]
        },
        {
          ...
          "items": [
            {
              ...
              "link": "/13-ai-coding-engineering/10-team-adoption"
            },
            {
              "text": "从 0 到 1 用 AI 做产品：未来属于能直接动手的人",
              "link": "/13-ai-coding-engineering/11-zero-to-one-with-ai"
            }
          ]
        }
      ]
          ...
          "items": [
            {
              ...
              "link": "/14-ai-coding-classics/01-harper-llm-codegen-workflow"
            },
            {
              "text": "初级开发者的复仇（Steve Yegge 名篇全文翻译）",
              "link": "/14-ai-coding-classics/02-yegge-revenge-of-the-junior-developer"
            },
            {
              "text": "Ralph Wiggum 作为\"软件工程师\"（Geoffrey Huntley 名篇全文翻译）",
              "link": "/14-ai-coding-classics/03-ralph-wiggum-software-engineer"
            }
          ]
        },
        {
  ...
  "/15-project-analysis/": [
    {
      "text": "模块 15 · 优质项目源码分析",
      "link": "/15-project-analysis/",
      "collapsed": false,
      "items": [
        {
          "text": "Dify 工作流引擎源码解析——节点编排、变量系统与沙箱执行",
          "link": "/15-project-analysis/01-dify-workflow-engine"
        },
        {
          "text": "n8n 执行引擎源码解析——任务运行器与节点式自动化",
          "link": "/15-project-analysis/02-n8n-execution-engine"
        },
        {
          "text": "RAGFlow 源码解析：深度文档理解与企业级 RAG 管线",
          "link": "/15-project-analysis/03-ragflow-rag-pipeline"
        },
        {
          "text": "browser-use 源码解析：浏览器 Agent 的控制循环与 DOM 提取",
          "link": "/15-project-analysis/04-browser-use-agent-loop"
        }
      ]
    }
  ],
  "/16-design-patterns-java/": [
    {
      "text": "模块 16 · Java 设计模式教学专栏",
      "link": "/16-design-patterns-java/",
      "collapsed": false,
      "items": [
        {
          "text": "专栏导读：iluwatar/java-design-patterns 与设计模式总览",
          "link": "/16-design-patterns-java/01-column-overview"
        },
        {
          "text": "创建型模式：单例、工厂与对象的受控诞生",
          "link": "/16-design-patterns-java/02-creational-patterns"
        },
        {
          "text": "结构型模式：组合优于继承的工程实践",
          "link": "/16-design-patterns-java/03-structural-patterns"
        },
        {
          "text": "行为型模式：对象间的职责分配与协作",
          "link": "/16-design-patterns-java/04-behavioral-patterns"
        },
        {
          "text": "企业级架构模式：从 Ambassador 到 Anti-Corruption Layer",
          "link": "/16-design-patterns-java/05-enterprise-patterns"
        }
      ]
    }
  ]
