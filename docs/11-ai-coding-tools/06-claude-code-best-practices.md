...
> 译注：本文与站内的提示工程、智能体主题文章多有呼应：给 Claude 可运行的验证手段即"让智能体闭合回路"，子智能体与并行会话的机制细节见《Subagents 与并行会话：把探索外包出去》，CLAUDE.md 与 Skills 则详见《Claude Skills：可复用技能包》与《AGENTS.md 与 CLAUDE.md：给智能体的项目规范文件》。
